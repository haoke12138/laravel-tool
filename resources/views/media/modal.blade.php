                ...
                {field: 'id', title: 'ID', sortable: true, visible: false},
                {
                    title: langs.preview, formatter: function (value, row) {
                        ...
                        if (row.media_type === 'image') {
                            html += '<img class="img-thumbnail modal-img-thumbnail " width="50px" src="' + row.url + '" data-action="mediaselector-preview-image" data-url="' + row.url + '">';
        ...
        layer.prompt({
            ...
            $.ajax({
                ...
                error: function (XmlHttpRequest) {
                    Dcat.error(XmlHttpRequest.responseJSON.msg);
                }
            });
            layer.close(index);
        });
